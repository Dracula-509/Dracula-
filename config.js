...
module.exports = {
     ...
     */
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+50956461555', 
     ...
     */
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Mr Dracula Dev',
    // name creator
//nom du créateur
    /** 
    ...
    OWNER_NUMBER: [
        '50956461555',  // Apna number yahan add karo
// your number phone
//ton numéro de téléphone
        '224666649030'   // Multiple owners add kar sakte ho
//delete +
...
//ton second numéro de téléphone
     ...
     * @type {string}
     */
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/DzuM6dhvtGqDXOGCCT4xQI?s=cl&p=a&ilr=4',
  //  let me change that
// link your gc
// lien de ton groupe WhatsApp
     ...
     * @type {string}
     */
    GROUP_INVITE_LINK_2: process.env.GROUP_INVITE_LINK_2 || 'https://chat.whatsapp.com/BM1FkKF6rEJDYn2e3EOmb9?s=cl&p=a&ilr=4',
// second gc
     ...
     * @type {string}
     */
    GROUP_INVITE_LINK_3: process.env.GROUP_INVITE_LINK_3 || 'https://chat.whatsapp.com/GudreUVqkxF7ayX40OGa8B?s=cl&p=a&ilr=4',
// again 3 gc
    // ═══════════════════════════════════════════════════════════════════════
...
//bot image /
     ...
     * @type {string}
     */
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbCFoFrCcW4txYtoCH2F',
...
lien de ta chaîne WhatsApp
     ...
     * @type {string}
     */
    CHANNEL_LINK_2: process.env.CHANNEL_LINK_2 || 'https://whatsapp.com/channel/0029Vb73wdHDzgTHNuQA942e',
//your second Channel link
    /**
     * @description Troisième channel (newsletter) WhatsApp — lien ou JID direct (xxx@newsletter)
     * @type {string}
     */
    CHANNEL_LINK_3: process.env.CHANNEL_LINK_3 || 'https://whatsapp.com/channel/0029Vb7xX0I8vd1Iv6thSs2H',
//that too 
//ça aussi
    /**
